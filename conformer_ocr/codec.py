...
__all__ = ['TransformerCodec']

logger = logging.getLogger(__name__)


class TransformerCodec(object):
    """
    ...
    def merge(self, codec: 'TransformerCodec') -> Tuple['TransformerCodec', Set]:
        """
        ...
        Args:
            codec: TransformerCodec to merge with
        ...
        return TransformerCodec(c2l_cand, self.strict), set(rm_labels)

    def add_labels(self, charset: Union[Dict[str, Sequence[int]], Sequence[str], str]) -> 'TransformerCodec':
        """
        ...
        return TransformerCodec(c2l, self.strict)

    def __repr__(self):
        return f'TransformerCodec({self.c2l})'
